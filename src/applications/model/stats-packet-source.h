...
private:
  ...
  // Traced Callback: sent packet, source node ID in NodeList, source app index in ApplicationList, sink Address.
  TracedCallback<Ptr<const Packet>, uint32_t, uint32_t, const Address & > m_txTrace;
